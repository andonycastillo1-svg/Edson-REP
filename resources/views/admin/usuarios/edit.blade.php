        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <select name="role_id" id="role_id" required
                    ...
                    <option value="1" {{ (int)old('role_id', $usuario->role_id) === 1 ? 'selected' : '' }}>Administrador</option>
                    <option value="2" {{ (int)old('role_id', $usuario->role_id) === 2 ? 'selected' : '' }}>Encargado</option>
                    <option value="3" {{ (int)old('role_id', $usuario->role_id) === 3 ? 'selected' : '' }}>Coordinador</option>
                    <option value="4" {{ (int)old('role_id', $usuario->role_id) === 4 ? 'selected' : '' }}>Consultas</option>
