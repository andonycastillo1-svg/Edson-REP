...
@php
    ...
    $almacenistaActualId = optional($usuario->almacenistasAsignados->first())->id;
    $almacenistaSeleccionadoId = old('almacenista_id', $almacenistaActualId);
@endphp
                ...
                <select name="almacenista_id"
                    ...
                    @foreach($almacenistas as $almacenista)
                        <option value="{{ $almacenista->id }}"
                            {{ (int) $almacenistaSeleccionadoId === (int) $almacenista->id ? 'selected' : '' }}>
