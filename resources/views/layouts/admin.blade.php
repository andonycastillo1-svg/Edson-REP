...
<body class="min-h-screen bg-gradient-to-br from-sky-100 via-cyan-50 to-blue-100 text-slate-900">
    ...
    <header class="sticky top-0 z-20 border-b border-sky-200 bg-white/90 backdrop-blur">
        <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-6">
            <div class="flex items-center gap-3 text-slate-700">
                <img src="{{ asset('img/logo1.png') }}" alt="Logo" class="h-11 w-11 rounded-md border border-sky-200 bg-white p-0.5 object-contain md:h-12 md:w-12">
